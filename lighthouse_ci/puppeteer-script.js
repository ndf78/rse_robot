...
module.exports = async (browser, context) => {
    ...
    // await page.type.$x('//input[@id="ap_email"]', 'romuald.classeur@gmail.com');
    // await page.click.$x('//input[@id="continue"]');
    // await page.waitForNavigation();
    // await page.type.$x('//input[@id="ap_password"]', 'ausyforever');
    // await page.click.$x('//input[@id="signInSubmit"]');
    // await page.waitForNavigation();
